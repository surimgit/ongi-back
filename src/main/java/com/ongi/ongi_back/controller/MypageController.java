...
public class MypageController {
  ...
  public ResponseEntity<? super GetOrderItemResponseDto> getOrderItemsByProductSequence(
    ...
    ResponseEntity<? super GetOrderItemResponseDto> response = mypageService
        .getOrderItemByProductSequence(productSequence);
    return response;
  }
  ...
  public ResponseEntity<? super GetHelperApplyListRespeonseDto> getHelperApplyList(
      @PathVariable("postSequence") Integer postSequence,
      @AuthenticationPrincipal String userId) {
    ResponseEntity<? super GetHelperApplyListRespeonseDto> response = mypageService.getHelperApplyList(userId,
        postSequence);
    return response;
  }
  ...
  public ResponseEntity<? super GetHelperCommentsResponseDto> getOtherUserHelperComments(
      @PathVariable("postSequence") Integer postSequence,
      @PathVariable("userId") String userId) {
    ResponseEntity<? super GetHelperCommentsResponseDto> response = mypageService
        .getOtherUserHelperComments(postSequence, userId);
    return response;
  }
